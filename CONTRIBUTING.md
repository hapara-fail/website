# Contributing to hapara.fail (Website)
...
5.  **Commit** your changes with a clear message:
    * *Good:* "Fix mobile navigation layout on small screens"
    * *Bad:* "update css"
...
## 🤝 Code of Conduct
We value accuracy, privacy, and collaboration. Please ensure your interactions—whether in issues, pull requests, or Discord—are respectful and constructive.
